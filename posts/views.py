...
class IndexView(TemplateView):
  ...
  def get_context_data(self, **kwargs):
    ...
    #context['general'] = Category.objects.filter(title__icontains='genel')
    context['general'] = Category.objects.get(slug="genel")
    return context
...
class BlogView(ListView):
  ...
  paginate_by=5
  #queryset = Post.objects.filter(title__icontains='yapısı')
