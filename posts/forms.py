...
class CreatePostForm(forms.ModelForm):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.helper.layout = Layout(
      Field("title", css_class="single-input", placeholder="Başlık Giriniz"),
      HTML("<hr>"),
      ...
      Field("image", css_class="nw-btn primary-btn mt-10"),
    )
    #self.helper.form_id = 'benimID'
    #self.helper.form_class = 'benimClass'
